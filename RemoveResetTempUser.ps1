...
#"DisablePrivacyExperience"=dword:00000001
REG ADD /f "HKLM\SOFTWARE\Policies\Microsoft\Windows\OOBE" -v DisablePrivacyExperience /t REG_DWORD /d 1
#Disable Edge first login prompt
REG ADD /f "HKLM\SOFTWARE\Policies\Microsoft\Edge" /v DisablePrivacyExperience /t REG_DWORD /d 1
REG ADD /f "HKLM\SOFTWARE\Policies\Microsoft\Edge" /v HideFirstRunExperience /t REG_DWORD /d 1
